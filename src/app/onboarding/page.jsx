...
export default function OnboardingPage() {
  ...
  // Local state for time inputs (12‑hour format)
  ...
  const [onboardingData, setOnboardingData] = useState({
    ...
    primaryGoal: '',
    interests: [],
    reminderTime: '09:00', // stored in 24‑hour format
    currentMood: '',
  });
  ...
  useEffect(() => {
    ...
    // Parse initial reminderTime (24h) into 12h format
    const [h, m] = onboardingData.reminderTime.split(':');
  ...
  // Update onboardingData.reminderTime whenever hour, minute, or period changes
  useEffect(() => {
  ...
  return (
    <div className="bg-[#f8f9fa] min-h-screen flex flex-col items-center justify-center text-[#202124] p-6">
      ...
      <div className="relative z-50 w-full max-w-5xl">
        ...
        {/* Content card */}
        <div className="bg-white rounded-[35px] p-8 md:p-12 border-[#dadce0]">
          <div className="text-center mb-8">
            <h2 className="text-3xl small md:text-4xl font-semibold text-[#000000] mb-3">
